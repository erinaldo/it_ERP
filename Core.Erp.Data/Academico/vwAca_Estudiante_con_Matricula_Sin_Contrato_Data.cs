...
{
    public class vwAca_Estudiante_con_Matricula_Sin_Contrato_Data
    {
        public List<vwAca_Estudiante_con_Matricula_Sin_Contrato_Info> Get_List_Estudiante_con_Matricula_Sin_Contrato_AnioLectivoActivo(int IdInstitucion, int IdAnioLectivoActivo)
        {
            try
            {
                ...
                {
                    var context = from c in Base.vwAca_Estudiante_con_Matricula_Sin_Contrato
                                  where c.IdInstitucion == IdInstitucion && c.IdAnioLectivo == IdAnioLectivoActivo
                                  select c;
                    if (context != null)
                    {
                        foreach (var item in context)
                        {
                            vwAca_Estudiante_con_Matricula_Sin_Contrato_Info Matricula_x_Estudiante_Info = new vwAca_Estudiante_con_Matricula_Sin_Contrato_Info();
