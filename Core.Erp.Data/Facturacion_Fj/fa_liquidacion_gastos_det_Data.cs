...
{
    public class fa_liquidacion_gastos_det_Data
    {
        ...
        public bool GuardarDB(fa_liquidacion_gastos_det_Info Info, ref string mensaje)
        {
            try
            {
                using (Entity_Facturacion_FJ Context = new Entity_Facturacion_FJ())
                {
                    fa_liquidacion_gastos_det contact = new fa_liquidacion_gastos_det();
                    ...
                    contact.Se_Genero_por_un_proceso = false;
                    Context.fa_liquidacion_gastos_det.Add(contact);
                    Context.SaveChanges();
                }
                return true;
            }
