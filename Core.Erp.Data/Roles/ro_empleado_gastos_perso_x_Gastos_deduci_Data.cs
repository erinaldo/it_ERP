...
{
    public class ro_empleado_gastos_perso_x_Gastos_deduci_Data
    {
        string mensaje = "";
        ...
        public int getId(int IdEmpresa, decimal idEmpleado, int anioFiscal)
        {
            ...
            try
            {
                ...
                var selecte = db.ro_empleado_gastos_perso_x_Gastos_deduci.Count(q => q.IdEmpresa == IdEmpresa 
                ...
                {
                    var select_em = (from q in db.ro_empleado_gastos_perso_x_Gastos_deduci
                                    where q.IdEmpresa == IdEmpresa 
                                    && q.IdEmpleado==idEmpleado && q.Anio_fiscal==anioFiscal
        ...
        public Boolean consultarAnio(int IdEmpresa, int IdEmpleado, int anio) {
            try
            {
                ...
                using (EntitiesRoles rol = new EntitiesRoles())
                {
                    var Consultar = from q in rol.ro_empleado_gastos_perso_x_Gastos_deduci
       ...
       public Boolean EliminarBD(int idEmpresa, decimal idEmpleado,int AnioFiscal, ref string msg)
        {
            try
            {
                ...
                using (EntitiesRoles db = new EntitiesRoles())
                {
                     db.Database.ExecuteSqlCommand("delete from dbo.ro_empleado_gastos_perso_x_Gastos_deduci where IdEmpresa =" + idEmpresa.ToString()
