    ...
    public class ro_Empleado_Novedad_Data
    {
        ...
        public bool Reversar_HorasExtras(int idempresa, int idnomina, int IdPeriodo)
        {
            try
            {
                ...
                using (EntitiesRoles context = new EntitiesRoles())
                {
                    context.Database.ExecuteSqlCommand("delete ro_empleado_novedad_det where IdEmpresa='" + idempresa + "' and IdNomina_tipo='" + idnomina + "' and  IdPeriodo='" + IdPeriodo + "'  ");
                    context.Database.ExecuteSqlCommand("delete ro_empleado_novedad where IdEmpresa='" + idempresa + "' and IdNomina_tipo='" + idnomina + "'  and IdPeriodo='" + IdPeriodo + "'  ");
