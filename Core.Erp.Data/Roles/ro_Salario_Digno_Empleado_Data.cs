...
{
   public  class ro_Salario_Digno_Empleado_Data
    {
           ...
           try
           {
               ...
               using (EntitiesRoles db = new EntitiesRoles())
               {
                   var datos = (from a in db.ro_salario_digno_empleado
                                where a.IdEmpresa == idEmpresa && a.IdNominaTipo == idNominaTipo && a.IdPeriodo == idPeriodo
                                select a);
       ...
       public Boolean EliminarBD(int idEmpresa, int idNomina, int idPeriodo, ref string msg)
       {
           try
           {
               ...
               using (EntitiesRoles db = new EntitiesRoles())
               {
                   db.Database.ExecuteSqlCommand("delete from dbo.ro_salario_digno_empleado where IdEmpresa =" + idEmpresa.ToString()
