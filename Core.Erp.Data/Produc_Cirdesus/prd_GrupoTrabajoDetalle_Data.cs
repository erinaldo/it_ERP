...
{
    public class prd_GrupoTrabajoDetalle_Data
    {
        string mensaje = "";
        public List<prd_GrupoTrabajoDetalle_Info> ObtenerGrupoTrabDetalle( decimal IdGrupoTrabajo, int idempresa, int IdSucursal)
        {
            try
            {
                ...
                List<prd_GrupoTrabajoDetalle_Info> lM = new List<prd_GrupoTrabajoDetalle_Info>();
        ...
        public List<prd_GrupoTrabajoDetalle_Info> ObtenerGrupoTrabDetalle(int IdEtapa, int IdProcesoProductivo)
        {
            try
            {
                ...
                var select = from C in OEProduccion.vwprd_GrupoTrabajoEtapa
                             where C.IdEtapa == IdEtapa && C.IdProcesoProductivo == IdProcesoProductivo
                             select C;
