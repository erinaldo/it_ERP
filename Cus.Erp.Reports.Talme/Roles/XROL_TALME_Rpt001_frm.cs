...
{
    public partial class XROL_TALME_Rpt001_frm : Form
    {
        int _idEmpresa;
        decimal _idEmpleado;
        int _idNominaTipo;
        ...
        public XROL_TALME_Rpt001_frm()
        {
            InitializeComponent();
            _idEmpresa = param.IdEmpresa;
        }

        public XROL_TALME_Rpt001_frm(int idEmpresa, decimal idEmpleado, int idNominaTipo, int idNominaTipoLiqui, int idPeriodo)
        {
            InitializeComponent();
        ...
        private void XROL_TALME_Rpt001_frm_Load(object sender, EventArgs e)
        {
        ...
        private void pu_GenerarReporte()
        {
            try
            {
                XROL_TALME_Rpt002_Rpt Reporte = new XROL_TALME_Rpt002_Rpt();
                ...
                if (pu_setInfo())
                {
                    Reporte.PIdEmpresa.Value = _idEmpresa;
                    Reporte.PIdNomina_Tipo.Value = _idNominaTipo;
                    Reporte.PIdNominaTipoLiqui.Value = _idNominaTipoLiqui;
                    Reporte.PIdPeriodo.Value = _idPeriodo;
