...
{
    public class fa_liquidacion_gastos_det_Historico_Bus
    {
        fa_liquidacion_gastos_det_Historico_Data oData = new fa_liquidacion_gastos_det_Historico_Data();
        ...
        public List<fa_liquidacion_gastos_det_Info> Get_List_Liquidacion_Gastos_Det_Historico(int IdEmpresa, decimal IdLiquidacion, ref string mensaje)
        {
            try
            {
                return oData.Get_List_Liquidacion_Gastos_Det_Historico(IdEmpresa, IdLiquidacion, ref mensaje);
            }
            catch (Exception ex)
            {
                mensaje = ex.ToString();
