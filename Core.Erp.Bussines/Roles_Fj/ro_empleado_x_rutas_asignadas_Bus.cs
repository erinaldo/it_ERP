...
{
  public  class ro_empleado_x_rutas_asignadas_Bus
  {
      string mensaje;
      ro_empleado_x_rutas_asignadas_Det_Data data_detalle = new ro_empleado_x_rutas_asignadas_Det_Data();
      ro_empleado_x_rutas_asignadas_Data data = new ro_empleado_x_rutas_asignadas_Data();
      ...
      public List<ro_empleado_x_rutas_asignadas_Info> listado_parametro_pago_variable(int IdEmpresa)
      {
          try
          {
