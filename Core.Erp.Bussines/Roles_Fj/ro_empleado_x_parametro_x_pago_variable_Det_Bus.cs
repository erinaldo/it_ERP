...
{
   public class ro_empleado_x_parametro_x_pago_variable_Det_Bus
   {
       string mensaje;
       ro_empleado_x_parametro_x_pago_variable_Det_Data data = new ro_empleado_x_parametro_x_pago_variable_Det_Data();
