...
{
    public partial class frmAF_Cambio_Ubicacion_Consul_FJ : Form
    {
        ...
        public frmAF_Cambio_Ubicacion_Consul_FJ()
        {
            InitializeComponent();
        ...
        private void frmAF_Cambio_Ubicacion_Consul_FJ_Load(object sender, EventArgs e)
        {
            try
            {
