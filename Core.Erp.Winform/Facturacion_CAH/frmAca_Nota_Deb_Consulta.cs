...
{
    public partial class frmAca_Nota_Deb_Consulta : Form
    {
        ...
        frmAca_Nota_Deb_Mant frm;
        #endregion

        #region " Constructor"
        public frmAca_Nota_Deb_Consulta()
        {
            InitializeComponent();
        ...
        private void frmAca_Nota_Deb_Consulta_Load(object sender, EventArgs e)
        {
            try
            {
