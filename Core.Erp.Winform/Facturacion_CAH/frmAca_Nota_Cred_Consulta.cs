...
{
    public partial class frmAca_Nota_Cred_Consulta : Form
    {
        ...
        #region " Constructor"
        public frmAca_Nota_Cred_Consulta()
        {
            InitializeComponent();
        ...
        private void frmAca_Nota_Cred_Consulta_Load(object sender, EventArgs e)
        {
            try
            {
                LlenarGrid();
        ...
        private void llama_frm(Cl_Enumeradores.eTipo_action Accion)
        {
            try
            {
                ...
                frmAca_Nota_Cred_Mant frm = new frmAca_Nota_Cred_Mant();
