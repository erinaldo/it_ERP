...
using Core.Erp.Winform.Inventario_Edehsa;

namespace Core.Erp.Winform.Inventario_Edehsa
{
    public partial class FrmIn_Producto_Cons_Edehsa : Form
    {
        ...
        FrmIn_Producto_Mant_Edehsa frm = new FrmIn_Producto_Mant_Edehsa();


        in_Producto_Info Info_Producto = new in_Producto_Info();

        //public FrmIn_ProductoCons()
        //{
        //    InitializeComponent();
        //}
        ...
        public FrmIn_Producto_Cons_Edehsa()
        {
            InitializeComponent();
            try
            {
        ...
        void ucGe_Menu_event_btnImpExcel_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                FrmIn_Producto_Wizard_Import_Edehsa frmImp = new FrmIn_Producto_Wizard_Import_Edehsa();
        ...
        private void Preparar_Formulario(Cl_Enumeradores.eTipo_action iAccion)
        {
            ...
            try
            {
                ...
                {
                    frm = new FrmIn_Producto_Mant_Edehsa();
