...
{
    public partial class FrmPrd_GrupoTrabajoConsulta : Form
    {
        public FrmPrd_GrupoTrabajoConsulta()
        {
            try
            {
                    InitializeComponent();
        ...
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnNuevo_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                FrmPrd_GrupoTrabajoMantenimiento frm = new FrmPrd_GrupoTrabajoMantenimiento();
                frm.set_Accion(Cl_Enumeradores.eTipo_action.grabar);
                frm.Text = frm.Text + " ***NUEVO REGISTRO***"; frm.MdiParent = this.MdiParent;
                frm.Show();

              //  frm.EVENT_FrmPrd_GrupoTrabajoMantenimiento_FormClosing += new FrmPrd_GrupoTrabajoMantenimiento.delegate_FrmPrd_GrupoTrabajoMantenimiento_FormClosing(frm_EVENT_FrmPrd_GrupoTrabajoMantenimiento_FormClosing);
        ...
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnModificar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                InfoGrupoTrabajo = (prd_GrupoTrabajo_Info)gridViewGrupoTrabajo.GetFocusedRow();
        ...
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnAnular_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                else if (MessageBox.Show("¿Está seguro que desea Anular / Inactivar el Grupo de Trabajo " + InfoGrupoTrabajo.Descripcion + " ?", "Anulación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    frm.Show(); frm.setCab(InfoGrupoTrabajo); frm.EVENT_FrmPrd_GrupoTrabajoMantenimiento_FormClosing += new FrmPrd_GrupoTrabajoMantenimiento.delegate_FrmPrd_GrupoTrabajoMantenimiento_FormClosing(frm_EVENT_FrmPrd_GrupoTrabajoMantenimiento_FormClosing);
                }
            }
            catch (Exception ex)
            {
        ...
        prd_GrupoTrabajo_Bus BusProduccion = new prd_GrupoTrabajo_Bus();
        prd_GrupoTrabajo_Info InfoGrupoTrabajo = new prd_GrupoTrabajo_Info();
        ...
        private void gridViewGrupoTrabajo_RowCellStyle(object sender, DevExpress.XtraGrid.Views.Grid.RowCellStyleEventArgs e)
        {
            try
            {
                var data = gridViewGrupoTrabajo.GetRow(e.RowHandle) as prd_GrupoTrabajo_Info;
                if (data == null)
                    return;
                if (data.Estado == "I")
