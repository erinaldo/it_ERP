...
namespace Core.Erp.Winform.Roles_Fj
{
    public partial class frmRo_Asignacion_Ruta_x_empleado_Mant : Form
    {
        ...
        ro_zona_Bus bus_Zonas = new ro_zona_Bus();
        ...
        public void Cargar_Datos()
        {
            try
            {
                ...
                lista_Zonas = bus_Zonas.Get_List_Zona(param.IdEmpresa);
        ...
        private void cmb_parametros_variable_EditValueChanged(object sender, EventArgs e)
        {
