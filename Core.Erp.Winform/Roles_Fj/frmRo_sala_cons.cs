...
{
    public partial class frmRo_sala_cons : Form
    {
        ...
        void Cargar_Grid()
        {
            try
            {
                ...
                Lista_salas = Bus_sala.Get_List_sala(param.IdEmpresa, fechaDesde, fechaHasta, ref mensaje);
                gc_ruta.DataSource = Lista_salas;
            }
            catch (Exception ex)
            {
        ...
        private void Llamar_formulario(Cl_Enumeradores.eTipo_action Accion)
        {
            try
            {
                frm = new frmRo_sala_mant();
               // frm.event_frmRo_sala_mant_FormClosing += frm_event_frmRo_sala_mant_FormClosing;
                frm.Set_Accion(Accion);
                if (Accion != Cl_Enumeradores.eTipo_action.grabar)
                {
                    if (Info_sala != null)
                    {
                        frm.Set_Info(Info_sala);
        ...
        void frm_event_frmRo_sala_mant_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                Cargar_Grid();
