...
{
    public partial class frmRo_fuerza_cons : Form
    {
        ...
        frmRo_fuerza_mant frm;
        string mensaje = "";
        #endregion

        public frmRo_fuerza_cons()
        {
            InitializeComponent();
        }
        ...
        private void Llamar_formulario(Cl_Enumeradores.eTipo_action Accion)
        {
            try
            {
                frm = new frmRo_fuerza_mant();
                frm.event_frmRo_fuerza_mant_FormClosing += frm_event_frmRo_fuerza_mant_FormClosing;
                frm.Set_Accion(Accion);
                if (Accion != Cl_Enumeradores.eTipo_action.grabar)
                {
                    if (Info_Fuerza != null)
                    {
                        frm.Set_Info(Info_Fuerza);
        ...
        void frm_event_frmRo_fuerza_mant_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                Cargar_Grid();
        ...
        private void frmRo_fuerza_cons_Load(object sender, EventArgs e)
        {
            try
            {
                Cargar_Grid();
        ...
        private void gvw_fuerza_RowCellStyle(object sender, DevExpress.XtraGrid.Views.Grid.RowCellStyleEventArgs e)
        {
            try
            {
                var data = gvw_fuerza.GetRow(e.RowHandle) as ro_fuerza_Info;
                if (data == null)
                    return;
