...
{
    public partial class frmRo_placa_cons : Form
    {
        ...
        ro_placa_Info Info_Placa = new ro_placa_Info();
        ...
        frmRo_placa_mant frm;
        string mensaje = "";
        #endregion

        public frmRo_placa_cons()
        {
            InitializeComponent();
        }
        ...
        void Cargar_Grid()
        {
            try
            {
                ...
                Lista_Placa = Bus_Placa.Get_List_Placa(param.IdEmpresa, fechaDesde, fechaHasta, ref mensaje);
                gc_placa.DataSource = Lista_Placa;
            }
            catch (Exception ex)
            {
        ...
        private void Llamar_formulario(Cl_Enumeradores.eTipo_action Accion)
        {
            try
            {
                frm = new frmRo_placa_mant();
                frm.event_frmRo_placa_mant_FormClosing += frm_event_frmRo_placa_mant_FormClosing;
                frm.Set_Accion(Accion);
                if (Accion != Cl_Enumeradores.eTipo_action.grabar)
                {
                    if (Info_Placa != null)
                    {
                        frm.Set_Info(Info_Placa);
        ...
        void frm_event_frmRo_placa_mant_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                Cargar_Grid();
        ...
        private void frmRo_placa_cons_Load(object sender, EventArgs e)
        {
            try
            {
                Cargar_Grid();
        ...
        private void gvw_placa_RowCellStyle(object sender, DevExpress.XtraGrid.Views.Grid.RowCellStyleEventArgs e)
        {
            try
            {
                var data = gvw_placa.GetRow(e.RowHandle) as ro_placa_Info;
                if (data == null)
                    return;
