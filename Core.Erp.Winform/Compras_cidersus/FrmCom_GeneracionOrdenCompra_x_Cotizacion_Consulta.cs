...
{
    public partial class FrmCom_GeneracionOrdenCompra_x_Cotizacion_Consulta : Form
    {
        ...
        FrmCom_GeneracionOrdenCompra_x_Cotizacion_Mantenimiento frm = new FrmCom_GeneracionOrdenCompra_x_Cotizacion_Mantenimiento();
        ...
        public FrmCom_GeneracionOrdenCompra_x_Cotizacion_Consulta()
        {
            try
            {
             InitializeComponent();
        ...
        void frm_Event_FrmCom_GeneracionOrdenCompra_x_Cotizacion_Mantenimiento(object sender, FormClosingEventArgs e)
        {
            

        }
        private void FrmCom_GeneracionOrdenCompra_x_Cotizacion_Consulta_Load(object sender, EventArgs e)
        {           
        }     
        ...
        void frm_event_frmCom_OrdenCompra_x_Cotizacion_Mant_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                cargagrid();
