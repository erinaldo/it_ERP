...
{
    public partial class frmCon_CentroCosto_x_Cliente_Consul_FJ : Form
    {
        ...
        string MensajeError = "";
        frmCon_CentroCosto_x_cliente_Mant_FJ frmMant_cc_x_cliente;

        public frmCon_CentroCosto_x_Cliente_Consul_FJ()
        {
            InitializeComponent();
        }
        ...
        private void Cargar_CentroCosto_x_cliente()
        {
            try
            {
                ...
                _List_centro_costo_Info = _Centro_costo_Bus.Get_list_Centro_Costo_x_cliente_Consulta(param.IdEmpresa);
        ...
        private void LlamarFormulario(Cl_Enumeradores.eTipo_action Accion)
        {
            try
            {
                frmMant_cc_x_cliente = new frmCon_CentroCosto_x_cliente_Mant_FJ();
