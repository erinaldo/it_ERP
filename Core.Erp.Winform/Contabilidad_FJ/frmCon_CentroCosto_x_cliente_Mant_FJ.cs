...
{
    public partial class frmCon_CentroCosto_x_cliente_Mant_FJ : Form
    {
        #region "variables"
        ...
        #endregion 
        public frmCon_CentroCosto_x_cliente_Mant_FJ()
        {
            InitializeComponent();
        ...
        private void set_info_in_controls()
        {
            ...
            try
            {
                ...
                if (Info_centro_costo.IdCliente_cli!=0) cmbCliente.EditValue = Info_centro_costo.IdCliente_cli;
