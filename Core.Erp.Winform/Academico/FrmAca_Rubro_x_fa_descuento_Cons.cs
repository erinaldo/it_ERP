...
{
    public partial class FrmAca_Rubro_x_fa_descuento_Cons : Form
    {
        public FrmAca_Rubro_x_fa_descuento_Cons()
        {
            InitializeComponent();
        }
        ...
        private void load_Data()
        {
            try
            {
                ...
                gridControlRubroDescuento.DataSource = Lista;
        ...
        private void FrmAca_Rubro_x_fa_descuento_Cons_Load(object sender, EventArgs e)
        {
            try
            {
                load_Data();
        ...
        private void ucGe_Menu_Mantenimiento_x_usuario1_event_btnModificar_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                Info = (fa_descuento_Info)this.gridViewRubroDescuento.GetFocusedRow();
                if (Info == null)
                {
        ...
        private void ucGe_Menu_Mantenimiento_x_usuario1_event_btnImprimir_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                this.gridControlRubroDescuento.ShowPrintPreview();
            }
            catch (Exception ex)
            {
                string NameMetodo = System.Reflection.MethodBase.GetCurrentMethod().Name;
        ...
        private void gridViewDescuento_RowCellStyle(object sender, DevExpress.XtraGrid.Views.Grid.RowCellStyleEventArgs e)
        {
            try
            {
                var data = gridViewRubroDescuento.GetRow(e.RowHandle) as fa_descuento_Info;
                if (data == null)
                    return;
