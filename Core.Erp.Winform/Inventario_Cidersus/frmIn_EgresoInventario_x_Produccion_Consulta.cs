...
{
    public partial class frmIn_EgresoInventario_x_Produccion_Consulta : Form
    {
        ...
        void ucGe_Menu_Mantenimiento_x_usuario_event_btnNuevo_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                frmIn_EgresoInventario_x_Produccion_Mantenimiento frm = new frmIn_EgresoInventario_x_Produccion_Mantenimiento();
                frm.set_Accion(Cl_Enumeradores.eTipo_action.grabar);
                frm.Text = frm.Text + " ***NUEVO REGISTRO***";
                frm.MdiParent = this.MdiParent;
                frm.Show();
                frm.event_frmIn_EgresoInventario_x_Produccion_Mantenimiento_FormClosing += frm_event_frmIn_EgresoInventario_x_Produccion_Mantenimiento_FormClosing;
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        frmIn_EgresoInventario_x_Produccion_Mantenimiento fAjus = new frmIn_EgresoInventario_x_Produccion_Mantenimiento();
                ...
                if (_MoviInvenInfo != null)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            fAjus.MdiParent = this.MdiParent;
                            fAjus.Show();
                            fAjus.event_frmIn_EgresoInventario_x_Produccion_Mantenimiento_FormClosing += frm_event_frmIn_EgresoInventario_x_Produccion_Mantenimiento_FormClosing;
