...
namespace Core.Erp.Winform.Facturacion_Grafinpren
{
    public partial class frmFa_Factura_Consulta : Form
    {
        ...
        //fa_factura_det_Bus busDetFact = new fa_factura_det_Bus();
        ...
        Facturacion_Grafinpren.frmFa_Factura_Mant frm = new Facturacion_Grafinpren.frmFa_Factura_Mant();
        ...
        public void loadGrid()
        {
            try
            {
                lista = bus.Get_List_factura(param.IdEmpresa, ucGe_Menu_Mantenimiento_x_usuario.getIdSucursal, ucGe_Menu_Mantenimiento_x_usuario.getIdSucursal
