...
namespace Core.Erp.Winform.Facturacion_Grafinpren
{
    public partial class frmFa_Nota_Cred_Consulta : Form
    {
        ...
        Core.Erp.Business.Facturacion_Grafinpren.fa_notaCreDeb_graf_Bus Bus_Nota = new Business.Facturacion_Grafinpren.fa_notaCreDeb_graf_Bus();
        ...
        private void LlenarGrid()
        {
            try
            {
                Lst_nota = Bus_Nota.Get_List_Notas(param.IdEmpresa, ucGe_Menu_Mantenimiento_x_usuario.getIdSucursal, ucGe_Menu_Mantenimiento_x_usuario.getIdSucursal
                                                            , ucGe_Menu_Mantenimiento_x_usuario.getIdBodega, ucGe_Menu_Mantenimiento_x_usuario.getIdBodega
                                                            , ucGe_Menu_Mantenimiento_x_usuario.fecha_desde, ucGe_Menu_Mantenimiento_x_usuario.fecha_hasta, "C", ref MensajeError);
