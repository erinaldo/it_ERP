...
{
    public class XPRO_CUS_CID_Rpt009_Data
    {
        string mensaje = "";
        public List< XPRO_CUS_CID_Rpt009_Info> Get_Codigo_Barra( int IdEmpresa,int IdSucursal, int IdBodega, int IdMovi_inven_tipo, int IdNumMovi)
        {
            try
            {
                List<XPRO_CUS_CID_Rpt009_Info> lista = new List<XPRO_CUS_CID_Rpt009_Info>();
                using (EntitiesProduccion_Edehsa_Rpt db= new EntitiesProduccion_Edehsa_Rpt())
                {
                   ...
                   {
                       XPRO_CUS_CID_Rpt009_Info info = new XPRO_CUS_CID_Rpt009_Info();
