...
{
    public class XCOMP_CAH_Rpt001_Data
    {
        public List<XCOMP_CAH_Rpt001_Info> consultar_data(int idempresa, int idsucursal, decimal idordencompra)
        {
            try
            {
                List<XCOMP_CAH_Rpt001_Info> listadatos = new List<XCOMP_CAH_Rpt001_Info>();

                using (Entities_Compras_CAH ECompras = new Entities_Compras_CAH())
                {
                    var select = from q in ECompras.vwCOMP_CAH_Rpt001
                    ...
                    {
                        XCOMP_CAH_Rpt001_Info itemInfo = new XCOMP_CAH_Rpt001_Info();
                        ...
                        itemInfo.MotivoAnulacion = item.MotivoAnulacion;
