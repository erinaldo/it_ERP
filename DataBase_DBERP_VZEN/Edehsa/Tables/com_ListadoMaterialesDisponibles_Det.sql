CREATE TABLE [Edehsa].[com_ListadoMaterialesDisponibles_Det] (
    ...
    CONSTRAINT [PK_com_ListadoMaterialesDisponibles_Det] PRIMARY KEY CLUSTERED ([IdEmpresa] ASC, [IdListadoMaterialesDisponibles] ASC, [IdDetalle] ASC)
);
