CREATE TABLE [dbo].[Af_Depreciacion_x_cta_cbtecble] (
    ...
    CONSTRAINT [FK_Af_Depreciacion_x_cta_cbtecble_Af_Depreciacion] FOREIGN KEY ([IdEmpresa], [IdDepreciacion], [IdTipoDepreciacion]) REFERENCES [dbo].[Af_Depreciacion] ([IdEmpresa], [IdDepreciacion], [IdTipoDepreciacion]),
