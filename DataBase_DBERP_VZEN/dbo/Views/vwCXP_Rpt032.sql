...
SELECT        cp_conciliacion_Caja_det.IdEmpresa, cp_conciliacion_Caja_det.IdConciliacion_Caja, cp_conciliacion_Caja_det.Secuencia, cp_conciliacion_Caja_det.IdEmpresa_OGiro, 
                         ...
                         cp_conciliacion_Caja_det.Tipo_documento, cp_conciliacion_Caja_det.IdEmpresa_OP, cp_conciliacion_Caja_det.IdOrdenPago_OP, cp_orden_giro.IdProveedor, cp_proveedor.pr_nombre, cp_orden_giro.co_serie, 
