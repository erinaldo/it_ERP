...
SELECT        det_NT.IdEmpresa, det_NT.IdSucursal, det_NT.IdBodega, det_NT.IdNota, SUM(det_NT.sc_iva) AS Iva, SUM(det_NT.sc_subtotal) AS Sub_total, SUM(det_NT.sc_total) AS Total, 
                         SUM(det_NT.sc_descUni * det_NT.sc_cantidad) AS Des_total, det_NT.IdPunto_cargo_grupo, det_NT.IdPunto_Cargo, prod_x_bod.IdProducto, prod_x_bod.IdCtaCble_Vta, prod_x_bod.IdCtaCble_Des0, 
                         prod_x_bod.IdCtaCble_DesIva, det_NT.IdCod_Impuesto_Iva, det_NT.IdCod_Impuesto_Ice, det_NT.IdCentroCosto, det_NT.IdCentroCosto_sub_centro_costo, Imp_Iva.IdCtaCble AS IdCtaCble_Iva, 
...
GROUP BY det_NT.IdEmpresa, det_NT.IdSucursal, det_NT.IdBodega, det_NT.IdNota, det_NT.IdPunto_cargo_grupo, det_NT.IdPunto_Cargo, prod_x_bod.IdProducto, prod_x_bod.IdCtaCble_Vta, prod_x_bod.IdCtaCble_Des0, 
                         prod_x_bod.IdCtaCble_DesIva, det_NT.IdCod_Impuesto_Iva, det_NT.IdCod_Impuesto_Ice, det_NT.IdCentroCosto, det_NT.IdCentroCosto_sub_centro_costo, Imp_Iva.IdCtaCble, Imp_Ice.IdCtaCble