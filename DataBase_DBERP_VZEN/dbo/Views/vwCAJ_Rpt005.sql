...
SELECT        tb_empresa.IdEmpresa, tb_empresa.em_nombre, tb_sucursal.IdSucursal, tb_sucursal.Su_Descripcion, caj_Caja.IdCaja, caj_Caja.ca_Descripcion, 
                        ...
                        ISNULL( caj_Caja_Movimiento_det.IdCobro_tipo,'EGRESO') AS IdCobro_tipo, cxc_cobro_tipo.tc_descripcion, caj_Caja_Movimiento.IdCbteCble, caj_Caja_Movimiento.IdTipocbte, 
                         caj_Caja_Movimiento_det.cr_Banco, caj_Caja_Movimiento_det.cr_cuenta, caj_Caja_Movimiento_det.cr_NumDocumento, caj_Caja_Movimiento_det.cr_Valor, 
...
FROM            caj_Caja_Movimiento INNER JOIN
                         ...
                         tb_empresa ON caj_Caja.IdEmpresa = tb_empresa.IdEmpresa INNER JOIN
                         tb_sucursal ON caj_Caja_Movimiento.IdEmpresa = tb_sucursal.IdEmpresa AND caj_Caja_Movimiento.IdSucursal = tb_sucursal.IdSucursal LEFT OUTER JOIN
