...
AS
SELECT        A.IdEmpresa, A.IdTipoDocumento, A.pe_cedulaRuc, A.vt_tipoDoc, A.vt_Subtotal0 AS baseNoGraIva, A.vt_SubtotalIva AS baseImpGrav, A.vt_Subtotal AS baseImponible, A.vt_iva AS montoIva, A.IdCbteVta, 
