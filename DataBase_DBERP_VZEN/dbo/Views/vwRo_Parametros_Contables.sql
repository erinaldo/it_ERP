...
SELECT        dbo.ro_area.IdEmpresa, dbo.ro_Config_Param_contable.IdDivision, dbo.ro_Config_Param_contable.IdArea, dbo.ro_Config_Param_contable.IdDepartamento, 
                         ...
                         dbo.ro_rubro_tipo.rub_ctacon, dbo.ro_rubro_tipo.rub_provision, dbo.ro_rubro_tipo.rub_guarda_rol, dbo.ro_rubro_tipo.rub_aplica_IESS, dbo.ro_rubro_tipo.rub_utilid, 
                         dbo.ro_rubro_tipo.rub_prorrateo, dbo.ro_rubro_tipo.rub_acumula, dbo.ro_rubro_tipo.rub_noafecta, dbo.ro_rubro_tipo.rub_liquida, dbo.ro_rubro_tipo.rub_grupo, 
                         dbo.ro_rubro_tipo.rub_antici, dbo.ro_rubro_tipo.rub_gencon, dbo.ro_rubro_tipo.rub_Contabiliza_x_empleado
