...
SELECT        cp_conciliacion_Caja_det_x_ValeCaja.IdEmpresa, cp_conciliacion_Caja_det_x_ValeCaja.IdConciliacion_Caja, cp_conciliacion_Caja_det_x_ValeCaja.Secuencia, 
                         ...
                         cp_conciliacion_Caja_det_x_ValeCaja.IdCtaCble, cp_conciliacion_Caja_det_x_ValeCaja.IdPunto_cargo, cp_conciliacion_Caja_det_x_ValeCaja.IdPunto_cargo_grupo, caj_Caja_Movimiento.cm_beneficiario, 
