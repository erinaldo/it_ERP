...
SELECT        com_ordencompra_local_det.IdEmpresa, com_ordencompra_local_det.IdSucursal, com_ordencompra_local_det.IdOrdenCompra, 
                         ...
                         com_ordencompra_local.oc_fecha, cp_proveedor.IdProveedor, cp_proveedor.pr_codigo AS cod_provee, cp_proveedor.pr_nombre AS nom_provee, 
...
GROUP BY com_ordencompra_local_det.IdEmpresa, com_ordencompra_local_det.IdSucursal, com_ordencompra_local_det.IdOrdenCompra, 
                         ...
                         com_ordencompra_local.oc_fecha, cp_proveedor.IdProveedor, cp_proveedor.pr_codigo, cp_proveedor.pr_nombre, com_ordencompra_local.IdEstadoAprobacion_cat, 
