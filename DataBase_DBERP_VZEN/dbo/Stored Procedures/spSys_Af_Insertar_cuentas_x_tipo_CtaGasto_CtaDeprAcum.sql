	...
	BEGIN --CURSOR PARA CUENTAS DE ACTIVO
			...
			DECLARE Activos_cursor CURSOR FOR   
					...
					FROM            Af_Activo_fijo INNER JOIN
								Af_Activo_fijo_tipo ON Af_Activo_fijo.IdEmpresa = Af_Activo_fijo_tipo.IdEmpresa AND Af_Activo_fijo.IdActijoFijoTipo = Af_Activo_fijo_tipo.IdActijoFijoTipo
