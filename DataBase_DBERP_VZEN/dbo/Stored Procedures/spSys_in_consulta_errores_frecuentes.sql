...
SELECT        in_Ing_Egr_Inven_det.IdEmpresa,in_Ing_Egr_Inven_det.IdSucursal,in_Ing_Egr_Inven_det.IdBodega,in_Ing_Egr_Inven_det.IdMovi_inven_tipo, in_Ing_Egr_Inven_det.IdNumMovi,in_Ing_Egr_Inven_det.Secuencia, in_Ing_Egr_Inven_det.IdEstadoAproba,
...
and in_Ing_Egr_Inven_det.IdEstadoAproba = 'APRO'
	...
	IF(@Corregir = 1)
	BEGIN
		update in_Ing_Egr_Inven_det set IdEstadoAproba = 'PEND'
		from(
			SELECT        in_Ing_Egr_Inven_det.IdEmpresa,in_Ing_Egr_Inven_det.IdSucursal,in_Ing_Egr_Inven_det.IdBodega,in_Ing_Egr_Inven_det.IdMovi_inven_tipo, in_Ing_Egr_Inven_det.IdNumMovi,in_Ing_Egr_Inven_det.Secuencia, in_Ing_Egr_Inven_det.IdEstadoAproba,
			in_Ing_Egr_Inven.cm_fecha
			FROM            in_Ing_Egr_Inven_det INNER JOIN
		...
		BEGIN
           ...
           ,[IdCbteCble_ct])
			...
			BEGIN --INVENTARIO
				...
				WHERE EXISTS(
				SELECT eli.IdEmpresa FROM [tb_spSys_in_consulta_errores_frecuentes_eliminar_movimientos_sin_relacion] eli
				WHERE in_movi_inve_detalle_x_item.IdEmpresa = eli.IdEmpresa
				and in_movi_inve_detalle_x_item.IdSucursal = eli.IdSucursal
				and in_movi_inve_detalle_x_item.IdBodega = eli.IdBodega
				and in_movi_inve_detalle_x_item.IdMovi_inven_tipo = eli.IdMovi_inven_tipo
				and in_movi_inve_detalle_x_item.IdNumMovi = eli.IdNumMovi
				and eli.IdUsuario = @IdUsuario
				)
				DELETE in_movi_inve_detalle
				WHERE EXISTS(
				SELECT eli.IdEmpresa FROM [tb_spSys_in_consulta_errores_frecuentes_eliminar_movimientos_sin_relacion] eli
				WHERE in_movi_inve_detalle.IdEmpresa = eli.IdEmpresa
				and in_movi_inve_detalle.IdSucursal = eli.IdSucursal
				and in_movi_inve_detalle.IdBodega = eli.IdBodega
				and in_movi_inve_detalle.IdMovi_inven_tipo = eli.IdMovi_inven_tipo
				and in_movi_inve_detalle.IdNumMovi = eli.IdNumMovi
				and eli.IdUsuario = @IdUsuario
				)
				DELETE in_movi_inve
				WHERE EXISTS(
				SELECT eli.IdEmpresa FROM [tb_spSys_in_consulta_errores_frecuentes_eliminar_movimientos_sin_relacion] eli
				WHERE in_movi_inve.IdEmpresa = eli.IdEmpresa
				and in_movi_inve.IdSucursal = eli.IdSucursal
				and in_movi_inve.IdBodega = eli.IdBodega
				and in_movi_inve.IdMovi_inven_tipo = eli.IdMovi_inven_tipo
				and in_movi_inve.IdNumMovi = eli.IdNumMovi
				and eli.IdUsuario = @IdUsuario
				)
			END
