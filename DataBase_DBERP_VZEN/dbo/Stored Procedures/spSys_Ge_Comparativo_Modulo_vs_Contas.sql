...
SELECT         ct_cbtecble.IdEmpresa, ct_cbtecble.IdSucursal, tb_sucursal.codigo, NULL AS IdBodega, ct_cbtecble.IdCbteCble, ct_cbtecble_tipo.CodTipoCbte, NULL 
...
FROM            ct_cbtecble INNER JOIN
                         ct_cbtecble_det ON ct_cbtecble.IdEmpresa = ct_cbtecble_det.IdEmpresa AND ct_cbtecble.IdTipoCbte = ct_cbtecble_det.IdTipoCbte AND 
                         ct_cbtecble.IdCbteCble = ct_cbtecble_det.IdCbteCble INNER JOIN
                         tb_sucursal ON ct_cbtecble.IdEmpresa = tb_sucursal.IdEmpresa AND ct_cbtecble.IdSucursal = tb_sucursal.IdSucursal INNER JOIN
