...
{
    public partial class XINV_FJ_Rpt004_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();

        public XINV_FJ_Rpt004_Rpt()
        {
            InitializeComponent();
            xlbl_idReporte.Text = "XINV_FJ_Rpt004_Rpt";
        }

        private void XINV_FJ_Rpt004_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                XINV_FJ_Rpt004_Bus OBUS = new XINV_FJ_Rpt004_Bus();

                List<XINV_FJ_Rpt004_Info> ListDataRpt = new List<XINV_FJ_Rpt004_Info>();
                ...
                ListDataRpt = OBUS.get_Kardex_Detallado(param.IdEmpresa, IdBodegaIni, IdBodegaFin, IdSucursalIni, IdSucursalFin, IdProductoIni, IdProductoFin, IdCentroCosto, IdCentroCosto_sub_centro_costo, FechaIni, FechaFin);
            ...
            catch (Exception ex)
            {
                ...
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "XINV_FJ_Rpt004_Rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XINV_FJ_Rpt004_Rpt) };
            }
        }
