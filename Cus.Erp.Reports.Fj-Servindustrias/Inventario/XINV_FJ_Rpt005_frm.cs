...
{
    public partial class XINV_FJ_Rpt005_frm : Form
    {
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();

        public XINV_FJ_Rpt005_frm()
        {
            InitializeComponent();
        ...
        void CargarReporte()
        {
            try
            {
                XINV_FJ_Rpt005_Rpt Reporte = new XINV_FJ_Rpt005_Rpt();
        ...
        private void XINV_FJ_Rpt005_frm_Load(object sender, EventArgs e)
        {
