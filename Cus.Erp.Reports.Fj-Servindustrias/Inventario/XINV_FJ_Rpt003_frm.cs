...
{
    public partial class XINV_FJ_Rpt003_frm : Form
    {        
        cl_parametrosGenerales_Bus param= cl_parametrosGenerales_Bus.Instance;
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();
        
        public XINV_FJ_Rpt003_frm()
        {
            InitializeComponent();
        ...
        void CargarGrid()
        {
            try 
            {	  
                XINV_FJ_Rpt003_rpt Reporte = new XINV_FJ_Rpt003_rpt();
        ...
        private void XINV_FJ_Rpt003_frm_Load(object sender, EventArgs e)
        {
            try
            {
