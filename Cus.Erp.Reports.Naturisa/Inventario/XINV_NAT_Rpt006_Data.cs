...
{
    class XINV_NAT_Rpt006_Data
    {
        public List<XINV_NAT_Rpt006_Info> Get_list(int IdEmpresa, int IdSucursal, List<int> lst_bodega, decimal IdProducto, string IdCentroCosto, List<string> lst_subcentro, DateTime Fecha_ini, DateTime Fecha_fin)
        {
            try
            {
                ...
                List<XINV_NAT_Rpt006_Info> Lista = new List<XINV_NAT_Rpt006_Info>();
                using (EntitiesInventario_Rpt_Natu Context = new EntitiesInventario_Rpt_Natu())
                {
                    ...
                    {
                        XINV_NAT_Rpt006_Info info = new XINV_NAT_Rpt006_Info();
