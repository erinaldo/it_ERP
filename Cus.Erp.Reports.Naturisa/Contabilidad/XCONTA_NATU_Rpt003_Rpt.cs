...
{
    public partial class XCONTA_NATU_Rpt003_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();

        public XCONTA_NATU_Rpt003_Rpt()
        {
            InitializeComponent();
        }

        private void XCONTA_NATU_Rpt003_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                XCONTA_NATU_Rpt003_Bus repbus = new XCONTA_NATU_Rpt003_Bus();

                List<XCONTA_NATU_Rpt003_Info> ListDataRpt = new List<XCONTA_NATU_Rpt003_Info>();
            ...
            catch (Exception ex)
            {
                ...
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "XCONTA_Rpt003_rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XCONTA_NATU_Rpt003_Rpt) };
            }
        }
    }
}
