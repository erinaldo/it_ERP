...
{
    public partial class XCONTA_NATU_Rpt001_Rpt : DevExpress.XtraReports.UI.XtraReport
    {
        cl_parametrosGenerales_Bus param = cl_parametrosGenerales_Bus.Instance;
        tb_sis_Log_Error_Vzen_Bus Log_Error_bus = new tb_sis_Log_Error_Vzen_Bus();

        public XCONTA_NATU_Rpt001_Rpt()
        {
            InitializeComponent();
        ...
        private void XCONTA_NATU_Rpt001_Rpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                XCONTA_NATU_Rpt001_Bus BusRpt = new XCONTA_NATU_Rpt001_Bus();
                List<XCONTA_NATU_Rpt001_Info> ListaRpt = new List<XCONTA_NATU_Rpt001_Info>();
                ...
                ListaRpt = BusRpt.Get_List_Reporte(idEmpresa, FechaIni, FechaFin, IdCentroCosto, IdPunto_Cargo_Grupo, IdPunto_Cargo, Mostrar_Cero,Mostrar_CC);
            ...
            catch (Exception ex)
            {
                ...
                throw new Core.Erp.Info.Log_Exception.DalException(string.Format("", "XCONTA_NATU_Rpt001_Rpt_BeforePrint", ex.Message), ex) { EntityType = typeof(XCONTA_NATU_Rpt001_Rpt) };
            }
        }
    }
}
