...
{
    public partial class XCXP_NATU_Rpt003_frm : Form
    {
        ...
        public XCXP_NATU_Rpt003_frm()
        {
            InitializeComponent();
        }

        private void XCXP_NATU_Rpt003_frm_Load(object sender, EventArgs e)
        {
            try
            {
                cargar_combos();
        ...
        private void cmb_tipo_persona_EditValueChanged(object sender, EventArgs e)
        {
            ...
            cmb_proveedor.Properties.DataSource = list_Beneficiario;
        }

        private void btn_procesar_reporte_Click(object sender, EventArgs e)
        {
            XCXP_NATU_Rpt003_Rpt Reporte = new XCXP_NATU_Rpt003_Rpt();
            ...
            Reporte.Parameters["Tipo_Persona"].Value = cmb_tipo_persona.EditValue;
            Reporte.Parameters["Fecha_Ini"].Value = dtp_desde.Value;
            Reporte.Parameters["Fecha_Fin"].Value = dtp_hasta.Value;
            Reporte.Parameters["IdProveedor"].Value = cmb_proveedor.EditValue;
            Reporte.Parameters["Persona"].Value = cmb_tipo_persona.Text;
            //Reporte.Parameters["S_claseProveedor"].Value = cmb_proveedor.Text;
            //Reporte.Parameters["S_Fecha_Ini"].Value = dtp_desde.Text;
            //Reporte.Parameters["S_Fecha_Fin"].Value = dtp_hasta.Text;
            Reporte.Parameters["FechaImpresion"].Value = DateTime.Now.ToString();
            Reporte.Parameters["Empresa_Nom"].Value = param.InfoEmpresa.em_nombre;
